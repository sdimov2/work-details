...
work_detail: work_detail.o
	rm -f work_detail
	cc work_detail.o -o work_detail # Runs third

work_detail.o: work_detail.c
	cc -c work_detail.c -o work_detail.o # Runs second

#gcc -o work_detail work_detail.c
cleanwd:
	rm -f work_detail
# parameters:
